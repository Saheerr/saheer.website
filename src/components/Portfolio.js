    ...
    <div className="min-h-screen bg-[#1a1f3c] relative">
      ...
      <nav className="sticky top-0 bg-[#2a2f4c] border-b border-gray-700 z-50">
        <div className="max-w-5xl mx-auto px-6 py-4">
          <div className="flex gap-6 justify-center text-white">
            <button onClick={() => scrollToSection(projectsRef)} className="hover:text-gray-300 px-4 py-2 rounded-lg hover:bg-[#1a1f3c] transition-colors">
              Projects
            </button>
            <button onClick={() => scrollToSection(technologiesRef)} className="hover:text-gray-300 px-4 py-2 rounded-lg hover:bg-[#1a1f3c] transition-colors">
              Technologies
            </button>
            <button onClick={() => scrollToSection(experienceRef)} className="hover:text-gray-300 px-4 py-2 rounded-lg hover:bg-[#1a1f3c] transition-colors">
              Experience
            </button>
            <button onClick={() => scrollToSection(blogsRef)} className="hover:text-gray-300 px-4 py-2 rounded-lg hover:bg-[#1a1f3c] transition-colors">
              Blogs
            </button>
          </div>
        </div>
      ...
      <div className="py-12">
        <div className="max-w-5xl mx-auto px-6">
          ...
          Hi, I'm Saheer, a Computer Science student at UB with a minor in Economics. I bring a strong foundation in data science and software engineering, with experience analyzing economic trends and developing interactive dashboards in Power BI. My technical background includes full-stack development using React, Django, and Node.js, as well as designing normalized PostgreSQL databases and optimizing query performance. I also write data-driven blog posts on economic topics, demonstrating my ability to extract insights and communicate complex ideas clearly. I am actively seeking opportunities where I can apply my skills to solve realHi, I'm Saheer, a Computer Science student at UB with a minor in Economics. I specialize in data science, where I analyze economic trends and develop interactive dashboards using Power BI. My technical expertise spans full-stack development with React, Django, and Node.js. I have experience designing fully normalized PostgreSQL databases, optimizing complex queries, and building scalable web applications. I also publish blog posts on economic research topics, translating real-world data into meaningful insights.-world problems through data and technology.
          </div>
          <div className="flex gap-4">
            ...
            <a href="https://www.linkedin.com/in/saheer-rahman-40098728a/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300 transition-colors">
              <Linkedin size={24} />
            </a>
            <a href="mailto:saheerrahman98@gmail.com" className="text-white hover:text-gray-300 transition-colors">
              <Mail size={24} />
            </a>
          </div>
          <a
            href="/Saheer Rahman Resume 2025.pdf"
            download
            className="mt-6 inline-block px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors"
          >
            Download Resume
          </a>
        </div>
      ...
      <section
        ref={technologiesRef}
        className="mb-16 bg-[#2a2f4c] p-8 rounded-xl border border-gray-700 max-w-5xl mx-auto"
      >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#1a1f3c] p-6 rounded-lg border border-gray-700 hover:border-blue-500 transition-colors">
            ...
            <button
              onClick={() =>
                window.alert("This is a school project — please contact me at saheerrahman98@gmail.com for the code.")
              }
      ...
      <section className="mb-16 bg-[#2a2f4c] p-8 rounded-xl border border-gray-700 max-w-5xl mx-auto">
      ...
      <section
        ...
        className="mb-16 bg-[#2a2f4c] p-8 rounded-xl border border-gray-700 max-w-5xl mx-auto"
      >
        <h2 className="text-3xl md:text-4xl font-bold mb-])), text-white">Blogs</h2>
        <div className="text-white text-xl md:text-2xl text-center">Upcoming!</div>
      </section>

      {/* Pacman Animation */}
      <div className="fixed left-8 top-0 bottom-0 w-8 z-50" style={{ pointerEvents: 'none' }}>
        <div
          className="absolute"
          style={{ top: `${leftPacmanPosition}%`, fontSize: '3rem', transform: 'translateY(-50%)' }}
        >
          👾
        </div>
      </div>
      <div className="fixed right-8 top-0 bottom-0 w-8 z-50" style={{ pointerEvents: 'none' }}>
        <div
          className="absolute"
          style={{ top: `${rightPacmanPosition}%`, fontSize: '3rem', transform: 'translateY(-50%)' }}
        >
          👾
        </div>
      </div>
